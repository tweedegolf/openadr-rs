...
use crate::generated::models::{SubscriptionObjectOperationsInner, ValuesMap};
...
impl Subscription {
    ...
    pub fn new(client_name: String, program_id: String, object_operations: Vec<SubscriptionObjectOperationsInner>) -> Subscription {
        Subscription {
            id: None,
