...
pub struct ProgramProgramDescriptionsInner {
    /// A human or machine readable program description
    #[serde(rename = "URL")]
    pub url: String,
}

impl ProgramProgramDescriptionsInner {
    pub fn new(url: String) -> ProgramProgramDescriptionsInner {
        ProgramProgramDescriptionsInner {
            url,
        }
    }
}
